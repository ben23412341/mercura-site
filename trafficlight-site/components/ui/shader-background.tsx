...
// Defined outside component — truly constant, never re-created
const VS_SOURCE = `
...
const FS_SOURCE = `
  ...
  const vec4 lineColor = vec4(0.0, 1.0, 0.533, 1.0);
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    // Dark near-black base, very subtle dark green tint on right
    vec4 bgColor1 = vec4(0.039, 0.039, 0.039, 1.0);
    vec4 bgColor2 = vec4(0.0, 0.05, 0.025, 1.0);
