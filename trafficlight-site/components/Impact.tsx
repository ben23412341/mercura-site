  ...
  return (
    <section id="impact" className="bg-[#0a0a0a] overflow-hidden py-6 sm:py-8 lg:py-10">
      <div className="mx-auto max-w-7xl flex flex-col lg:flex-row items-center">
        ...
        {/* ── Right: text ── */}
        <motion.div
          className="w-full lg:w-1/2 px-6 md:px-10 py-16 lg:py-0"
        ...
        >
          ...
          <p
            ...
            style={{ color: '#ebebeb' }}
          >
            Real results from our v1 AI traffic light optimizer prototype.
          </p>
